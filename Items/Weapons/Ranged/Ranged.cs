...
public class Ranged : Weapon
{
    ...
    protected Transform fireProjectile(float angle_in, bool use_ammo = true)
    {
        ...
        tempTrans.eulerAngles = new Vector3(0f, (angle_in * Mathf.Rad2Deg) - 90f, 90f);
        tempTrans.GetComponent<Rigidbody>().velocity = new Vector3(Mathf.Sin(angle_in) * projectileVelocity, 0f, Mathf.Cos(angle_in) * projectileVelocity);
