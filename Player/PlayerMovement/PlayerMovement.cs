...
public class PlayerMovement : MonoBehaviour
{
    ...
    [SerializeField] private float runSpeedMultiplier = 1.7f;
    ...
    public void Move()
    {
        ...
        if (desired_movement.magnitude > 1f)
        {
            ...
            force = forceConst * desired_movement;
        }
        else
        {
            force = forceConst * desired_movement;
    ...
    public void PauseAimTowardCamera()
    {
        ...
        transform.rotation = Quaternion.RotateTowards(transform.rotation, Quaternion.Euler(new Vector3(0, 225f, 0)), 270 * Time.unscaledDeltaTime);
    }

    public void DialogueMenuAimTowards(Transform npcTransform)
    {
        moveState = MoveState.Idle;
