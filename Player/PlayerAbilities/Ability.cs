...
public class Ability : MonoBehaviour
{
    ...
    {
        float xp_out;
        if (current_level < ReturnLevelCap())
        {
    ...
    ////////////////////////////////////////////////////////
    private int ReturnLevelCap()
    {
        int[] LevelCapArray = new int[5]{playerStats.ReturnDerivedIntrinsicSkill(DerivedIntrinsicSkillsEnum.Vigor), playerStats.ReturnDerivedIntrinsicSkill(DerivedIntrinsicSkillsEnum.Cerebral),
            playerStats.ReturnDerivedIntrinsicSkill(DerivedIntrinsicSkillsEnum.Fortitude), 10, 10 };

        return LevelCapArray[(int)abilityType];
    }
    ...
    {
        return (1f + ((float)current_level * 0.05f));
    }
